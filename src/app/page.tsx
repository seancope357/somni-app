...
import { Loader2, Mic, MicOff, Sparkles, Book, BookOpen, History, TrendingUp, Search, X, LogOut, Heart, Brain, Zap, Calendar, Lightbulb, Settings, Mail, CalendarDays, MessageCircle, Home as HomeIcon, Trophy, Moon } from 'lucide-react'
...
export default function Home() {
  ...
  const [currentView, setCurrentView] = useState<'dashboard' | 'interpret' | 'history' | 'patterns' | 'sleep' | 'journal' | 'events' | 'insights' | 'settings' | 'digest' | 'timeline' | 'gamification'>('dashboard')
        ...
        <div className="flex justify-center mb-4 sm:mb-8">
          <div className="bg-white/95 backdrop-blur-lg rounded-2xl p-1.5 flex flex-wrap justify-center gap-1.5 shadow-xl border border-white/40">
            ...
            >
              ...
              <span className="hidden sm:inline">Sleep Tracker</span>
            </Button>
            <Button
              variant="ghost"
              size="sm"
